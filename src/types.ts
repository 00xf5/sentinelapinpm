...
export interface SentinelConfig {
    ...
    /**
     * Trust Token options
     * Automatically verifies tokens generated by the Sentinel Widget
     */
    verifyToken?: boolean;     // Enable automatic token identification
    trustTokenField?: string;  // Custom form field name (Default: 'sentinel-token')
